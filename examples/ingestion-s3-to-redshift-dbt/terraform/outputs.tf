...
# Purpose: Outputs for the ingestion-s3-to-redshift-dbt Terraform starter.
...
output "dp_eh_dbt_runtime_role_arn" {
  description = "IAM role ARN for the DP-EH dbt runtime."
  value       = module.dp_eh_dbt_runtime_role.role_arn
}
