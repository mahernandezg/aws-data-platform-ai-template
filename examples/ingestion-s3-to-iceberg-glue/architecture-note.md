# Architecture Note - Ingestion S3 to Iceberg

## Purpose

This note explains how the `ingestion-s3-to-iceberg-glue` example aligns to the repository architecture system.
...
- IAM Roles only
- no IAM Users
- least-privilege runtime access for Glue and Athena
...
The goal is to provide a first memorable accelerator example, not a complete enterprise deployment.
