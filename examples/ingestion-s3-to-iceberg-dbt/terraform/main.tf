...
# Purpose: Near-runnable Terraform starter for the ingestion-s3-to-iceberg-dbt example covering ISC Landing Zone, DP-EH dbt-oriented Iceberg processing, and DDC Athena exposure.
...
locals {
  ...
  standard_tags = {
    ...
    example_pattern = "ingestion-s3-to-iceberg-dbt"
  }
}
