...
# Purpose: Near-runnable Terraform starter for the ingestion-s3-to-iceberg-spark example covering ISC Landing Zone, DP-EH Spark-based Iceberg processing, and DDC Athena exposure.
...
locals {
  ...
  standard_tags = {
    ...
    example_pattern = "ingestion-s3-to-iceberg-spark"
  }
}
