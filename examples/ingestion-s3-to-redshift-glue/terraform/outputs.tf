...
# Purpose: Outputs for the ingestion-s3-to-redshift-glue Terraform starter.
...
output "dp_eh_glue_runtime_role_arn" {
  description = "IAM role ARN for the DP-EH Glue runtime."
  value       = module.dp_eh_glue_runtime_role.role_arn
}
